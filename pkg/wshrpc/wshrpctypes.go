...
type WshRpcInterface interface {
	...
	SetProjectConfigCommand(ctx context.Context, data ProjectConfigRequest) error
	DeleteProjectConfigCommand(ctx context.Context, projectKey string) error
